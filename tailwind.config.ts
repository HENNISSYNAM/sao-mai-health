	...
	theme: {
		...
		extend: {
			colors: {
				...
				dengue: 'hsl(var(--disease-dengue))',
				tcm: 'hsl(var(--disease-tcm))',
				ari: 'hsl(var(--disease-ari))',
				destructive: {
			...
			animation: {
				...
				'scale-reveal': 'scale-reveal 0.6s cubic-bezier(0.16,1,0.3,1) both',
