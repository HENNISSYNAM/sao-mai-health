  ...
  public: {
    Tables: {
      ...
      biovault_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "biovault_metrics_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "biovault_documents"
            referencedColumns: ["id"]
          },
        ]
      }
      body_region_scans: {
        ...
        Relationships: [
          {
            foreignKeyName: "body_region_scans_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "body_scan_sessions"
            referencedColumns: ["id"]
          },
        ]
      }
      body_scan_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "body_scan_sessions_encounter_id_fkey"
            columns: ["encounter_id"]
            isOneToOne: false
            referencedRelation: "health_encounters"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      community_alert_votes: {
        ...
        Relationships: [
          {
            foreignKeyName: "community_alert_votes_alert_id_fkey"
            columns: ["alert_id"]
            isOneToOne: false
      ...
      community_alerts: {
        Row: {
          ...
          promoted_to_hotspot: boolean | null
          severity: string
          status: string
          updated_at: string
          user_id: string
      ...
      health_encounters: {
        Row: {
          ai_diagnosis_codes: string[] | null
          ai_summary: string | null
          biological_age: number | null
          body_regions_scanned: string[] | null
          body_scan_session_id: string | null
          clinical_measurements: Json | null
          confidence: number | null
          created_at: string
          dermatology_findings: Json | null
          encounter_code: string
          facial_metrics: Json | null
          id: string
          inferred_health: Json | null
          notes: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "health_encounters_body_scan_session_id_fkey"
            columns: ["body_scan_session_id"]
            isOneToOne: false
            referencedRelation: "body_scan_sessions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "health_encounters_record_id_fkey"
            columns: ["record_id"]
            isOneToOne: false
      ...
      scan_clinical_measurements: {
        ...
        Relationships: [
          {
            foreignKeyName: "scan_clinical_measurements_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "body_scan_sessions"
            referencedColumns: ["id"]
      ...
      scan_dermatology: {
        ...
        Relationships: [
          {
            foreignKeyName: "scan_dermatology_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "body_scan_sessions"
            referencedColumns: ["id"]
      ...
      scan_facial_landmarks: {
        Row: {
          ...
          created_at: string
          drooping_indicators: Json | null
          expression_analysis: Json | null
          facial_symmetry_score: number | null
          id: string
          landmark_count: number | null
          left_right_deviation: number | null
          muscle_tone_map: Json | null
          pigmentation_map: Json | null
          raw_landmarks: Json | null
          session_id: string
          skin_elasticity_map: Json | null
          stroke_risk_indicators: Json | null
          user_id: string
          vascular_pattern: Json | null
          wrinkle_map: Json | null
        }
        Insert: {
          bells_palsy_score?: number | null
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "scan_facial_landmarks_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "body_scan_sessions"
            referencedColumns: ["id"]
      ...
      scan_media: {
        ...
        Relationships: [
          {
            foreignKeyName: "scan_media_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "body_scan_sessions"
            referencedColumns: ["id"]
      ...
      scan_vital_signs: {
        Row: {
          ...
          blood_glucose_estimate: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "scan_vital_signs_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "body_scan_sessions"
            referencedColumns: ["id"]
      ...
      sensor_daily_summary: {
        Row: {
          accelerometer_samples: number | null
          ambient_light_avg_lux: number | null
          avg_activity_level: string | null
          avg_tremor_intensity: number | null
          balance_avg_score: number | null
          balance_issue_count: number | null
          created_at: string
          date: string
          environment_snapshot: Json | null
          fall_events: number | null
          gyroscope_samples: number | null
          id: string
          magnetic_field_avg: number | null
          total_steps: number | null
          tremor_events: number | null
          updated_at: string
          user_id: string
        }
        Insert: {
    ...
    Functions: {
      ...
      apply_edu_discount:
        ...
        | {
            Args: { p_amount?: number; p_cooldown?: string; p_email: string }
            Returns: Json
          }
      ...
      generate_encounter_code: { Args: never; Returns: string }
      generate_order_code: { Args: never; Returns: string }
      generate_patient_code: { Args: never; Returns: string }
      generate_scan_session_code: { Args: never; Returns: string }
