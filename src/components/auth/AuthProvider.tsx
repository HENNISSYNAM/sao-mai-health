...
import { useCachedProfile, UserProfile } from '@/hooks/useCachedProfile';
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const { profile, loading: profileLoading, updateProfile } = useCachedProfile();
  const { isOnline, pendingSync } = useSyncEngine();
