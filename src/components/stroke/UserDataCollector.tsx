...
import { DeviceSensorsPanel } from "@/components/stroke/DeviceSensorsPanel";
  ...
  useEffect(() => {
    if (onDataCollected) {
      onDataCollected({
        ...
        environment,
        sensors: deviceSensors.isAnyActive ? deviceSensors.health : undefined
      });
    }
  }, [phone, gps, currentPressure, environment, deviceSensors.health, onDataCollected]);
    ...
    <Card className="border-primary/20 bg-card/80 backdrop-blur">
      ...
      <CardContent className="space-y-4">
        ...
        <DeviceSensorsPanel
          ...
          onStartAll={deviceSensors.startAll}
          onStopAll={deviceSensors.stopAll}
          onResetFall={deviceSensors.resetFallAlert}
        />
