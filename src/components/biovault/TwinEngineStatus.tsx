            ...
            <div className="relative w-24 h-24">
              <svg className="w-full h-full transform -rotate-90">
                ...
                <circle
                  ...
                  stroke="currentColor"
                  strokeWidth="8"
                  strokeDasharray={`${state.overallScore * 2.51} 251`}
                  className={riskColors[state.riskLevel]}
                />
              </svg>
              <div className="absolute inset-0 flex items-center justify-center">
                <span className={`text-2xl font-bold ${riskColors[state.riskLevel]}`}>
                  {state.overallScore}
                </span>
              </div>
            </div>
