    ...
    const searchResponse = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Bạn là chuyên gia phân tích tin tức y tế. 
Nhiệm vụ: Tìm kiếm và phân tích tin tức mới nhất về dịch bệnh tại Việt Nam.
Trả về JSON với format:
{
  "articles": [
    {
      "disease": "tên bệnh (dengue/covid19/hfmd/tuberculosis/...)",
      "cases": số ca bệnh (số nguyên),
      "location": "địa điểm",
      "date": "YYYY-MM-DD",
...
Chỉ trích xuất thông tin thực tế từ tin tức, không bịa ra.`
          },
          {
            role: 'user',
            content: `Tìm kiếm tin tức mới nhất về dịch bệnh tại Việt Nam trong 7 ngày qua. 
Tập trung vào: sốt xuất huyết (dengue), COVID-19, tay chân miệng (HFMD), lao (tuberculosis).
