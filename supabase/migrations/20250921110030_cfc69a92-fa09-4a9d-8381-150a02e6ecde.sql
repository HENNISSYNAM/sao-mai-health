-- Insert comprehensive demo surveillance data only  
...
-- Insert recent cases with varied timestamps for realistic demo
INSERT INTO case_events (disease_code, patient_hash, patient_age_bucket, patient_gender, symptoms, ward_id, district_id, facility_id, occurred_at, source, lat, lon) VALUES
...
('ari', 'ARI_NEW1', '35-44', 'F', '{"cough": true, "fever": true, "runny_nose": true}', 'Phường 7', 'Quận 7', (SELECT id FROM health_facilities LIMIT 1), now() - interval '15 minutes', 'clinic', 10.7320, 106.695),
('malaria', 'MAL_NEW1', '50-59', 'M', '{"fever": true, "chills": true, "probable": true}', 'Phường 9', 'Quận 9', (SELECT id FROM health_facilities LIMIT 1), now() - interval '5 minutes', 'hospital', 10.8310, 106.725);